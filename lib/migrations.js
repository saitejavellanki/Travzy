...
const migrationFilePath = path.join(migrationsDir, '01_initial_schema.sql');
fs.writeFileSync(migrationFilePath, `-- Initial schema migration
...
console.log('1. Go to https://app.supabase.com/project/pgfcpqfahuidhystvami');
console.log('2. Navigate to the SQL Editor');
console.log('3. Open the file from:', migrationFilePath);
...
console.log('   supabase link --project-ref pgfcpqfahuidhystvami');
console.log('3. Push the migration:');
console.log('   supabase db push');

console.log('\nMigration file structure created successfully!');